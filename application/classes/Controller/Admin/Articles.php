...
class Controller_Admin_Articles extends Controller {
    ...
    public function before() {
        ...
        $this->link=$this->root.'articles';
        $this->view->sidebar_active='cms';
        $this->view->sidebar_active_menu='articles';

        $this->table='bsc_articles';
    ...
    {
        $this->view->path[]=array('caption'=>'Lista artykułów','url'=>$this->link.'/list');
        $this->view->title='Lista artykułów';
        ...
        $t->tableView->title='Lista artykulów';
